...
import styles from './NarrationAuthGate.module.css';
...
interface NarrationAuthGateProps {
  onAuthenticate: () => void;
}

export default function NarrationAuthGate({ onAuthenticate }: NarrationAuthGateProps) {
  return (
    <div className={styles.gate}>
      ...
      <p className={styles.subtext}>
        Create a free account to unlock smart narration on every photo — spotting
        features, flagging issues, and comparing to market.
      </p>
