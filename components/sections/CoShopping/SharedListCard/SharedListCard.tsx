    ...
    <div className={styles.card}>
      ...
      <div className={styles.topRow}>
        <div className={styles.photoArea}>
          ...
          {/* Saved heart */}
          <span className={styles.favoriteHeart} aria-label="Saved">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="#E53935" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
