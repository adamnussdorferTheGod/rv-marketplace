...
import styles from './VideoAuthGate.module.css';
...
interface VideoAuthGateProps {
  onAuthenticate: () => void;
}

export default function VideoAuthGate({ onAuthenticate }: VideoAuthGateProps) {
  return (
    <div className={styles.backdrop}>
      <div className={styles.card}>
        <h3 className={styles.heading}>Sign in to keep watching</h3>
        <p className={styles.subtext}>
          Create a free account to unlock the full AI video tour, deal analysis,
          and personalized RV insights.
        </p>
