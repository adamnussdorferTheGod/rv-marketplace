...
export const sampleListing: ListingData = {
  ...
  // Photos
  images: [
    { url: '/images/listing-rv-1.png', alt: '2024 Airstream Flying Cloud 25RB exterior side view with awning at mountain campsite' },
    { url: '/images/listing-rv-3.png', alt: '2024 Airstream Flying Cloud 25RB exterior front view at lakeside' },
    { url: '/images/listing-rv-2.png', alt: '2024 Airstream Flying Cloud 25RB exterior rear view at lake' },
    { url: '/images/listing-rv-4.png', alt: '2024 Airstream Flying Cloud 25RB side view with awning extended' },
    { url: '/images/listings/rv-03.png', alt: '2024 Airstream Flying Cloud 25RB interior kitchen' },
    { url: '/images/listings/rv-04.png', alt: '2024 Airstream Flying Cloud 25RB kitchen' },
    { url: '/images/listings/rv-05.png', alt: '2024 Airstream Flying Cloud 25RB bedroom' },
    { url: '/images/listing-rv-1.png', alt: '2024 Airstream Flying Cloud 25RB campsite with dog' },
    { url: '/images/listing-rv-3.png', alt: '2024 Airstream Flying Cloud 25RB front quarter angle' },
    { url: '/images/listings/rv-06.png', alt: '2024 Airstream Flying Cloud 25RB exterior campsite aerial' },
    { url: '/images/listings/rv-07.png', alt: '2024 Airstream Flying Cloud 25RB interior overview' },
  ],
  ...
  similarListings: [
    {
      ...
      model: 'Flying Cloud',
      price: 89900,
      imageUrl: '/images/listings/rv-02.png',
    ...
    },
    {
      ...
      model: 'Bambi',
      price: 68400,
      imageUrl: '/images/listings/rv-01.png',
      dealer: 'Suncoast Airstream',
      location: 'Clearwater, FL',
    },
  ],
