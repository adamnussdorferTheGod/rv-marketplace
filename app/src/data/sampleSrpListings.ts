...
const listingDefs: ListingDef[] = [
  ...
  // 2
  { rvType: 'travel-trailer', modelIndex: 0, trimIndex: 1, year: 2023, condition: 'used', price: 28500, originalPrice: null, dealRating: 'great', tagBadge: null, isFeatured: false, isSponsored: false, locationIndex: 1, lengthFt: 21, sleepingCapacity: 4, fuelType: 'n/a', floorPlan: null, gvw: 5800, mileage: null, daysOnSite: 30, photoCount: 4 },
  // 3
  ...
  // 5
  { rvType: 'travel-trailer', modelIndex: 1, trimIndex: 1, year: 2021, condition: 'used', price: 31000, originalPrice: null, dealRating: 'good', tagBadge: null, isFeatured: false, isSponsored: false, locationIndex: 5, lengthFt: 25, sleepingCapacity: 6, fuelType: 'n/a', floorPlan: null, gvw: 7000, mileage: null, daysOnSite: 42, photoCount: 4 },
  // 6
  ...
  // 12
  { rvType: 'travel-trailer', modelIndex: 4, trimIndex: 1, year: 2022, condition: 'used', price: 38500, originalPrice: null, dealRating: 'good', tagBadge: null, isFeatured: false, isSponsored: false, locationIndex: 9, lengthFt: 29, sleepingCapacity: 8, fuelType: 'n/a', floorPlan: 'Bunkhouse', gvw: 8200, mileage: null, daysOnSite: 25, photoCount: 5 },
  // 13
  ...
  // 18
  { rvType: 'travel-trailer', modelIndex: 4, trimIndex: 2, year: 2020, condition: 'used', price: 40000, originalPrice: null, dealRating: 'great', tagBadge: null, isFeatured: false, isSponsored: false, locationIndex: 17, lengthFt: 32, sleepingCapacity: 8, fuelType: 'n/a', floorPlan: 'Bunkhouse', gvw: 9000, mileage: null, daysOnSite: 50, photoCount: 4 },
  // 19
  ...
  // 27
  { rvType: 'fifth-wheel', modelIndex: 2, trimIndex: 0, year: 2023, condition: 'used', price: 72000, originalPrice: null, dealRating: 'good', tagBadge: null, isFeatured: false, isSponsored: false, locationIndex: 10, lengthFt: 33, sleepingCapacity: 6, fuelType: 'n/a', floorPlan: null, gvw: 12000, mileage: null, daysOnSite: 45, photoCount: 4 },
  // 28
  ...
  // 32
  { rvType: 'fifth-wheel', modelIndex: 1, trimIndex: 0, year: 2022, condition: 'used', price: 62000, originalPrice: null, dealRating: 'great', tagBadge: null, isFeatured: false, isSponsored: false, locationIndex: 14, lengthFt: 33, sleepingCapacity: 6, fuelType: 'n/a', floorPlan: 'Rear living', gvw: 11500, mileage: null, daysOnSite: 33, photoCount: 5 },
  ...
  // 38
  { rvType: 'class-a', modelIndex: 2, trimIndex: 1, year: 2021, condition: 'used', price: 385000, originalPrice: null, dealRating: 'good', tagBadge: null, isFeatured: false, isSponsored: false, locationIndex: 16, lengthFt: 40, sleepingCapacity: 6, fuelType: 'diesel', floorPlan: null, gvw: 40000, mileage: 8500, daysOnSite: 40, photoCount: 5 },
  // 39
  ...
  // 44
  { rvType: 'class-c', modelIndex: 0, trimIndex: 1, year: 2022, condition: 'used', price: 88000, originalPrice: null, dealRating: 'great', tagBadge: null, isFeatured: false, isSponsored: false, locationIndex: 5, lengthFt: 31, sleepingCapacity: 8, fuelType: 'gas', floorPlan: 'Bunkhouse', gvw: 16000, mileage: 15000, daysOnSite: 32, photoCount: 5 },
  // 45
  ...
  // 50
  { rvType: 'class-c', modelIndex: 3, trimIndex: 0, year: 2023, condition: 'used', price: 82000, originalPrice: null, dealRating: 'good', tagBadge: null, isFeatured: false, isSponsored: false, locationIndex: 7, lengthFt: 26, sleepingCapacity: 6, fuelType: 'gas', floorPlan: null, gvw: 14000, mileage: 12000, daysOnSite: 25, photoCount: 5 },
  // 51
  ...
  // 56
  { rvType: 'class-b', modelIndex: 1, trimIndex: 1, year: 2021, condition: 'used', price: 175000, originalPrice: null, dealRating: 'great', tagBadge: null, isFeatured: false, isSponsored: false, locationIndex: 16, lengthFt: 24, sleepingCapacity: 2, fuelType: 'diesel', floorPlan: null, gvw: 10500, mileage: 22000, daysOnSite: 35, photoCount: 5 },
  // 57
  ...
  // 72
  { rvType: 'pop-up', modelIndex: 0, trimIndex: 1, year: 2022, condition: 'used', price: 18000, originalPrice: null, dealRating: 'great', tagBadge: null, isFeatured: false, isSponsored: false, locationIndex: 11, lengthFt: 15, sleepingCapacity: 6, fuelType: 'n/a', floorPlan: null, gvw: 3800, mileage: null, daysOnSite: 42, photoCount: 4 },
  // 73
  ...
  // 77
  { rvType: 'pop-up', modelIndex: 2, trimIndex: 2, year: 2023, condition: 'used', price: 16000, originalPrice: null, dealRating: 'good', tagBadge: null, isFeatured: false, isSponsored: false, locationIndex: 9, lengthFt: 12, sleepingCapacity: 4, fuelType: 'n/a', floorPlan: null, gvw: 2400, mileage: null, daysOnSite: 30, photoCount: 4 },
  // 78
